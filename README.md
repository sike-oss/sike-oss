...
<h1 align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&duration=3000&pause=1000&color=0E75B6&center=true&vCenter=true&width=600&lines=Hi+there%2C+I'm+Imran+Arif+Munge;Full+Stack+Python+%26+MERN+Developer;Founder+%40+Nexus-Homes;Building+PhonoForensic" alt="Typing SVG" />
</h1>
...
<p align="center">
  ...
  <a href="https://www.hackerrank.com/imran20munge" target="_blank">
    <img src="https://img.shields.io/badge/-Hackerrank-2EC866?style=for-the-badge&logo=HackerRank&logoColor=white" alt="HackerRank" />
  </a>
  <a href="https://www.leetcode.com/sike_imran" target="_blank">
...
class ImranArif:
    def __init__(self):
        self.name       = "Imran Arif Munge"
        self.location   = "India"
        self.role       = "Full Stack Developer | Founder @ Nexus-Homes"
        self.languages  = ["Python", "JavaScript", "Java", "C++", "C"]
        self.stacks     = ["MERN", "Django", "React Native"]
        self.current    = ["PhonoForensic", "Nexus-Homes"]
        self.learning   = "Advanced AI/ML for Audio Analysis & Scalable Cloud Architecture"
        self.fun_fact   = "District & State-level Footballer — same hustle, different field"
